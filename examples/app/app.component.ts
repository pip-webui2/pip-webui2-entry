...
export class AppComponent {
    ...
    public list: any[] = [
        ...
        {
            name: 'email-verification', id: 'email-verification', route: 'email-verification-example'
        },
        {
            name: 'phone-verification', id: 'phone-verification', route: 'phone-verification-example'
        }
    ];
